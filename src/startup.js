...
const PLANS = Object.freeze({
  ...
  // terrain stream. Cosmetic models decode one at a time so a texture and geometry handoff cannot compound into one
  // long gameplay frame, while frame pressure can still pause every batch.
  cinematic: Object.freeze({ id: 'cinematic', constrainedTransfer: false, effectBudget: EFFECT_BUDGETS.cinematic, streamBudget: STREAM_BUDGETS.cinematic, warmShaders: true, blockingModels: Object.freeze([]), disabledModels: NO_DISABLED_MODELS, solidGrass: 'deferred', deferOptionalModels: true, releaseModelsAtTitle: true, titleModelReleaseDelayMs: 1200, modelConcurrency: 1, modelReleaseDelayMs: 700, modelBatchDelayMs: 420, modelIdleTimeoutMs: 1200, modelPressureMaxWaitMs: 6000, terrainReadiness: 'local', minWaitMs: 800, maxWaitMs: 6000, compileDelayMs: 0 }),
});
